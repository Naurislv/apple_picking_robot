# encoding=utf-8
# source cloned from https://github.com/PeterisP/pp_applepicker/blob/nvidia-docker/nn_agent/guntis3.py
# version 1.3 (PyTORCH saving )
# version 1.4 broader command set (speed regulation)
import numpy as np
...
#D=60*80
# in 480x640x3
# out 60x80x1  , I = I[::8,::8,1] downsample
D=120*160
#increase steps from 80 to 100 , v2.2
episode_length = 100

# valid_actions = ['i','j','l',',','p']
#valid_actions =1
valid_actions = ['F1','F2','F3','F4','F5','F6','F7','F8','F9',
...
#
def prepro(I):    
  #I = I[::8,::8,1] # downsample by factor of 8 (80x60), choose colour 2 to improve visibility in other games
  I = I[::4,::4,1] # downsample by factor of 4 (120x160), choose colour 2 to improve visibility in other games   
